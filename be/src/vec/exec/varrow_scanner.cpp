...
Status VArrowScanner::_init_src_block(Block* block) {
    size_t batch_pos = 0;
...
Status VArrowScanner::_eval_conjunts(Block* block) {
...
void VArrowScanner::_fill_columns_from_path(Block* block) {
...
Status VArrowScanner::_materialize_block(Block* block, Block* dest_block) {
    int ctx_idx = 0;
    size_t orig_rows = block->rows();
